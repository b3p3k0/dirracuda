...
- Put web-only dependencies in experimental/webui/requirements-web.txt, not requirements.txt.
...
FastAPI, Uvicorn, Jinja2. Put them in experimental/webui/requirements-web.txt. Add a health route
