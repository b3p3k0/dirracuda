"""
gui/browsers/smb_browser.py — SmbBrowserWindow (extracted in Card C5).

Contains the SMB-specific browser window and its config/banner helpers.
...
class SmbBrowserWindow(UnifiedBrowserCore):
    ...
    def _open_viewer(self, remote_path: str, content: bytes, size: int, truncated: bool) -> None:
        ...
        # as the monkeypatch target (§2c of BASELINE_CONTRACTS).
