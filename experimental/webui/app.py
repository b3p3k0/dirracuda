    ...
    async def _searxng_run(
        ...
        def _runner(job):
            ...
            job.set_metadata(
                ...
                pacing_delay_seconds=result.pacing_delay_seconds,
                throttled_page_count=result.throttled_page_count,
                hard_retry_count=result.hard_retry_count,
                hard_retry_delay_seconds=result.hard_retry_delay_seconds,
                throttle_engines=list(result.throttle_engines),
